...
export const listInstalledApps = (list_of_instance_info, list_of_dna, list_of_running_instances) => {
...
export const listDownloadedApps = (downloaded_apps) => {
  ...
  return dataRefactor(downloaded_files_log);
}
